...
export default {
  ...
  methods: {
    ...
    //=====highlight=========
    gethighlight(page = 1){
      axios.get(`https://share-sport.2m-sport.com/api/highlight?page=${page}`).then((res)=>{
    ...
    //=====category=========
    getcategory(){
      axios.get("https://share-sport.2m-sport.com/api/category").then((res)=>{
    ...
    categorywhere(event) {
      this.method = true;
      this.gethighlight();
      axios.get("https://share-sport.2m-sport.com/api/highlight/category/" + event.id).then((res)=>{
        this.highlightsWhere = res.data;
      }).catch(function (error) {
          console.error(error);
      });
...
<div class="lg:px-0 md:px-0 md:mt-2">
  <!-- <div class="max-w-6xl mx-auto"> -->
    ...
    <div class="flex flex-col gap-x-2 gap-y-2 lg:gap-x-5 lg:gap-y-4 md:flex-row md:gap-x-5 md:gap-y-4">
      <div class=" from-gray-100 lg:md:w-9/12 md:w-9/12 px-2 rounded-md ">
        ...
        style="border-radius:5px 5px 0px 0px;"> 
            <div class="gap-x-2 items-center lg:gap-x-1 md:gap-x-1 text-gray-600">
              <div class="from-blue-900 flex items-center gap-x-2 px-2">
                ...
                <span class="inline-block text-lg lg:text-lg md:text-lg font-medium text-white"  v-if="lang == 'en'"> 
                  {{en.highligh}}
                </span>
      ...
      <div>
        <section class="archive-title">
          <div class="pre-title">
            <span class="category" v-if="lang == 'en'">ប្រភេទលីគ</span>
            ...
            <div class="term-badges">
              <div class="new-mumu example" >
                ...
                <button>
                  <a class="example-a" @click="categorywhere(value)" :value="value.ïd"> {{value.name}}</a>
                </button>  
                </span>
              </div>
            </div>
          ...
          <div style="float: left;padding-right: 10px;" class="width-man">
            <div class="relative box radis-sila">
              <a v-bind:href="'/highligh/'+value.id">
                ...
                <img v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.photo" class="radis-sila w-154 limit-w-img" >
              </a>
            </div>
          </div>
            ...
            <div class="text">
              ...
              <div class="description" >
                ...
                <div class="flex items-center gap-x-1">
                  <span class="text-gray-400"> {{value.date}}</span>
                </div>
              </div>
            </div>
          </div>
