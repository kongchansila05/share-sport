...
const showCalendar = ref(false);
  export default {
    ...
    //=====getleagues=========
      // getleagues(){
      //   const leaguesurl ='https://livescore6.p.rapidapi.com/leagues/v2/list';
      //   const leaguesScoreWhere = {
      ...
      //       }
      //     }
      //     axios.get(leaguesurl, leaguesScoreWhere).then((res)=>{
      //         this.leagues = res.data.Ccg;
      //         console.log(res.data.Ccg);
      //     }).catch(function (error) {
      //         console.error(error);
      //     });
      //   }
  ...
  <div class="container-sm">
    <div class="flex flex-col md:flex-row lg:flex-row justify-between lg:gap-x-2 md:gap-x-2">
      ...
      <div class="lg:w-5/12 md:w-7/12 w-full">
        ...
        >
          <div @click="getLiveScoreMethod(formatDate(date).slice(5,8))">
            <p
      ...
      data-aos-duration="800" >
        ...
        <!-- ----------"Live Now end"---------- -->
        <!-- -----------"LiveScoreWhere"--------- -->
        <div data-aos="zoom-in" data-aos-duration="1000" v-else-if="LiveScoreMethod == true">
          <div  class="px-2">
            <div class="group">
      ...
      data-aos-duration="800" >
        ...
        <!-- <div data-aos="zoom-in" data-aos-duration="1000" v-else-if="LiveScoreMethod == false">
          <div  class="px-2">
            <div class="group">
