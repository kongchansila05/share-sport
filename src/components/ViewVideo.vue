<script>
    import ProfileFB from './ProfileFB.vue'
    ...
    export default {
        ...
        methods: {
            ...
            //=====video=========
            getvideo(){
                const url = "https://share-sport.2m-sport.com/api/highlight/"+this.id
            //    const headers= {
                                ...
                                <div class="content text-gray-200 lg:leading-8 md:leading-8 lg:text-lg md:text-lg text-lg">
                                    <p>
                                        <vue-plyr :options="options">
                                                ...
                                                controls
                                                playsinline
                                                v-bind:data-poster="'https://share-sport.2m-sport.com/upload/'+ value.photo"
                                                >
                                                <source
                                                    size="720"
                                                    v-bind:src="'https://share-sport.2m-sport.com/upload/'+ value.video"
                                                    type="video/mp4"
                                                />
                                                <source
                                                    size="1080"
